...
### Build and Install
```
$ go get github.com/segmentio/Burrow
$ cd $GOPATH/src/github.com/segmentio/Burrow
$ gpm install
$ go install
```
...
### Configuration
For information on how to write your configuration file, check out the [detailed wiki](https://github.com/segmentio/Burrow/wiki)
